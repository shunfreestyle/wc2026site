      ...
      <div className="p-5">
        ...
        <div className="flex gap-2 mt-4">
          <Link
            ...
            className="flex-1 text-center text-xs font-bold py-2.5 rounded-lg border-2 transition-colors"
            style={{
          ...
          <Link
            ...
            className="flex-1 text-center text-xs font-bold py-2.5 rounded-lg text-white transition-opacity hover:opacity-90"
