      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex gap-2 mt-4">
          ...
          <a
            ...
            className="flex items-center justify-center text-xs font-bold h-9 px-3 rounded-lg border-2 border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors"
          >
            公式
          </a>
        </div>
      ...
      <section className="relative bg-gradient-to-br from-[#1A1A2E] via-[#2C3E50] to-[#1A1A2E] text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            <div>
              <Link href="/jleague" className="text-xs font-bold text-white/50 hover:text-white/80 transition-colors">
                &larr; {locale === "en" ? "J1 League" : "J1リーグ"}
              </Link>
              <p className="text-xs sm:text-sm font-bold tracking-widest text-white/60 mb-2 mt-3">
                MEIJI YASUDA J2·J3 HYAKUNEN SŌZŌ LEAGUE
              </p>
