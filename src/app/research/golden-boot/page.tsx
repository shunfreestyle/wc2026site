...
const players: Player[] = [
  ...
  },
  {
    ...
    qualGames: null,
    clubGoals: '20+',
    clubDetail: 'LaLiga 15G+5A / CL 5G / 全大会20G超',
    clubDetailEn: 'LaLiga 15G+5A / CL 5G / 20+ all comps',
    gsRating: '中〜高',
    gsRatingEn: 'Med-High',
    gsColor: 'text-yellow-400',
    tags: ['ブラジル不動のエース', 'ハイチ戦で大量得点可能', '25歳ピーク', 'バロンドール候補常連'],
    tagsEn: ['Brazil\'s undisputed star', 'Haiti = goal feast', '25yo peak', 'Ballon d\'Or contender'],
    injury: 'ハムストリング違和感のみ — 問題なし',
    injuryEn: 'Minor hamstring discomfort — no concern',
    injuryLevel: 'none',
    verdict: 'ブラジル不動のエース。ハイチ(FIFA83位・W杯最弱候補)戦は大量得点の可能性大。LaLiga 15G+CL 5Gの安定した得点力。Mbappéのチームメイトとして連携も抜群。怪我なくフルフィット。',
    verdictEn: 'Brazil\'s undisputed star. Haiti (FIFA ~83rd, weakest WC team) = guaranteed goal feast. 15 LaLiga + 5 CL goals = consistent output. Mbappé\'s teammate chemistry. Fully fit.',
    sources: [
      { label: 'Tribuna LaLiga Stats', url: 'https://tribuna.com/en/persons/vinicius-junior/stat/2025-2026/la-liga/' },
      { label: 'UEFA CL Stats', url: 'https://www.uefa.com/uefachampionsleague/clubs/players/250121533--vinicius-junior/statistics/' },
    ],
  },
  {
    rank: 5,
