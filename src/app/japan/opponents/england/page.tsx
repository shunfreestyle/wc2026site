...
const players: Player[] = [
  ...
  // ── MF ──
  { position: "MF", nameJa: "デクラン・ライス", club: "アーセナル", featured: true, comment: "アーセナルの心臓。守備力と展開力を兼ね備えたイングランド最高のMF", career: ["ウェストハム（2017-23）", "アーセナル（2023-）"], japanConnection: "アーセナル（2023-）で冨安健洋と同チーム。冨安を「最も信頼できるディフェンダーの一人」と評価している。" },
  ...
  { position: "FW", nameJa: "ブカヨ・サカ", club: "アーセナル", comment: "アーセナルの右翼を担う快速ウインガー。代表でも不可欠な存在", career: ["アーセナルU21", "アーセナル（2019-）"], japanConnection: "アーセナル（2019-）で冨安健洋と同チーム。右SBの冨安と右ウイングのサカのコンビはアーセナルの生命線。互いの信頼関係は厚い。" },
  ...
  { position: "FW", nameJa: "エベレチ・エゼ", club: "アーセナル", comment: "アーセナル移籍後も輝きを放つ技巧派アタッカー", career: ["QPR（2016-20）", "クリスタル・パレス（2020-24）", "アーセナル（2024-）"], japanConnection: "アーセナル（2024-）で冨安健洋と同チーム。" },
