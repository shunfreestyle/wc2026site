  ...
  // ── 第8節: C大阪 vs 神戸 ──
  {
    ...
    homeLineup: {
      ...
      players: [
        ...
        { number: 6,  name: "登里享平",                    position: "DF", isStarter: true },
        ...
        { number: 11, name: "チアゴ・アンドラーデ",        position: "MF", isStarter: true },
        { number: 17, name: "阪田澪哉",                    position: "MF", isStarter: true },
        { number: 18, name: "石渡ネルソン",                position: "MF", isStarter: true },
        { number: 27, name: "柴山昌也",                    position: "MF", isStarter: true },
        { number: 9,  name: "レオ・セアラ",                position: "FW", isStarter: true },
      ],
    },
    awayLineup: {
      formation: "4-3-3",
      players: [
        ...
        { number: 5,  name: "カエターノ",      position: "DF", isStarter: true },
        { number: 15, name: "山田海斗",        position: "DF", isStarter: true },
        { number: 8,  name: "山口蛍",          position: "MF", isStarter: true },
        { number: 14, name: "乾貴士",          position: "MF", isStarter: true },
        { number: 19, name: "ジエゴ",          position: "MF", isStarter: true },
        { number: 7,  name: "小松蓮",          position: "FW", isStarter: true },
        ...
        { number: 28, name: "濱崎健斗",        position: "MF", isStarter: false },
        { number: 44, name: "日高光揮",        position: "MF", isStarter: false },
        { number: 26, name: "ジェアン・パトリッキ", position: "FW", isStarter: false },
        { number: 40, name: "内野航太郎",      position: "FW", isStarter: false },
      ],
    },
    goals: [
