  ...
  // ── 第8節: 岡山 vs 長崎 ──
  {
    ...
    homeLineup: {
      ...
      players: [
        ...
        { number: 41, name: "宮本英治",          position: "MF", isStarter: true },
        { number: 26, name: "本山遥",            position: "MF", isStarter: true },
        { number: 8,  name: "江坂任",            position: "MF", isStarter: true },
        { number: 40, name: "河野孝汰",          position: "MF", isStarter: true, subOut: 46 },
        { number: 99, name: "ルカオ",            position: "FW", isStarter: true },
    ...
    awayLineup: {
      ...
      players: [
        ...
        { number: 4,  name: "エドゥアルド",        position: "DF", isStarter: true },
        { number: 48, name: "照山嶺人",            position: "DF", isStarter: true },
        { number: 50, name: "進藤亮佑",            position: "DF", isStarter: true },
        { number: 23, name: "米田隼也",            position: "MF", isStarter: true },
        { number: 21, name: "ディエゴ・ビトゥカ",  position: "MF", isStarter: true },
        { number: 5,  name: "山口蛍",              position: "MF", isStarter: true },
        { number: 8,  name: "岩崎悠人",            position: "MF", isStarter: true },
        { number: 34, name: "松本天夢",            position: "MF", isStarter: true },
        { number: 11, name: "ノーマン・キャンベル", position: "MF", isStarter: true },
        ...
        { number: 24, name: "山田陸",              position: "MF", isStarter: false },
        { number: 33, name: "笹柳翼",              position: "MF", isStarter: false },
        { number: 41, name: "長谷川元希",          position: "FW", isStarter: false },
        { number: 9,  name: "山﨑凌吾",            position: "FW", isStarter: false, subIn: 80 },
      ],
    },
    goals: [
