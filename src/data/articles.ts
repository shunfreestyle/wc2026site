...
export const articles: Article[] = [
  {
    id: "1748563200001",
    slug: "trifa-esim-north-america-plan-world-cup-2026",
    title: "【W杯2026遠征の必需品】海外eSIM「トリファ(trifa)」北米周遊プランが便利すぎる——アメリカ&メキシコを1枚でカバー、5分で設定完了【PR】",
    titleEn: "Must-Have for World Cup 2026: trifa eSIM North America Plan Covers USA & Mexico with One eSIM, Setup in 5 Minutes [Sponsored]",
    excerpt: "W杯2026の開催地アメリカ・メキシコを周遊する日本人サポーターにおすすめの海外eSIM「トリファ(trifa)」を紹介。北米周遊プランなら国をまたいでも1枚のeSIMでOK。アプリで5分で設定完了、24時間日本語サポート付き。フォロワー限定5%割引クーポンあり。",
    excerptEn: "Introducing trifa, the overseas eSIM perfect for Japanese supporters traveling across the USA and Mexico for FIFA World Cup 2026. The North America multi-country plan covers both nations with a single eSIM — set up in just 5 minutes via the app, with 24/7 Japanese-language support.",
    category: "W杯" as const,
    tags: ["W杯2026", "eSIM", "トリファ", "trifa", "北米周遊", "アメリカ", "メキシコ", "海外旅行", "通信", "PR"],
    tagsEn: ["World Cup 2026", "eSIM", "trifa", "North America", "USA", "Mexico", "Travel", "Connectivity", "Sponsored"],
    publishedAt: "2026-05-30",
    updatedAt: "2026-05-30",
    isPopular: false,
    sources: [
      { name: "trifa公式サイト", url: "https://www.trifa.co/" },
      { name: "trifa対応国一覧", url: "https://www.trifa.co/countries" },
    ],
    content: `W杯2026はアメリカ・メキシコ・カナダの3カ国で開催される。日本代表のグループステージの試合会場はアメリカ国内だが、ラウンド16以降やメキシコでの他国の試合も観たいというサポーターも多いはず。そんな北米周遊の遠征で頭を悩ませるのが「現地の通信環境」だ。

本記事では、北米周遊に対応した海外eSIM「トリファ(trifa)」を紹介する。アメリカとメキシコの両方で使える周遊プランがあり、W杯遠征にぴったりのサービスだ。

<div class="highlight-box">
<span class="point-label">POINT</span>
<span class="point-title">この記事はPR（タイアップ）記事です</span>
<p class="point-body">本記事はtrifa様との提携により作成しています。記事内にはフォロワー限定の割引クーポン情報を掲載しています。</p>
</div>

## トリファ(trifa)とは？

トリファは、世界200以上の国と地域に対応した海外eSIMサービス。日本国内利用者数No.1のeSIMアプリで、スマホにアプリをダウンロードするだけで、SIMカードの差し替えなしに海外でデータ通信が使えるようになる。

レンタルWiFiのように空港での受け取り・返却の手間がなく、物理的なSIMカードの購入も不要。アプリ上でプランを購入し、eSIMをインストールするだけで準備完了だ。

<table class="profile-table">
  <tbody>
    <tr><th>サービス名</th><td>トリファ（trifa）</td></tr>
    <tr><th>対応国・地域</th><td>世界200以上の国と地域</td></tr>
    <tr><th>データ容量</th><td>1GB / 3GB / 5GB / 10GB / 20GB / 30GB / 80GB / 無制限から選択</td></tr>
    <tr><th>利用期間</th><td>3日 / 7日 / 15日 / 31日 / 60日から選択</td></tr>
    <tr><th>料金目安</th><td>1GBあたり790円〜（国・地域により異なる）</td></tr>
    <tr><th>サポート</th><td>24時間対応・日本語チャットサポート</td></tr>
    <tr><th>決済方法</th><td>クレジットカード、Apple Pay、Google Pay</td></tr>
  </tbody>
</table>

<small>※ 時期により価格が変動する可能性あり。最新の料金はアプリでご確認ください。</small>

## なぜW杯2026遠征にトリファがおすすめなのか

### 1. 北米周遊プランでアメリカ&メキシコをカバー

W杯2026の試合会場はアメリカ11都市、メキシコ3都市、カナダ2都市に分散している。国をまたぐ移動のたびにSIMカードを買い替えるのは面倒だし、それぞれの国のプランを個別に買うとコストもかさむ。

トリファの北米周遊プランなら、1枚のeSIMでアメリカとメキシコの両方をカバーできる。国境を越えても再設定は不要で、シームレスにデータ通信を継続できるのが大きなメリットだ。

<div class="highlight-box">
<span class="point-label">POINT</span>
<span class="point-title">複数国をまたぐ遠征に最適</span>
<p class="point-body">北米周遊プランなら、アメリカでのグループステージ観戦後にメキシコへ移動しても、eSIMを買い直す必要なし。1枚で複数国をシームレスにカバーできる。</p>
</div>

### 2. たった5分で設定完了

トリファの設定はとにかく簡単。以下の3ステップで完了する。

<table class="schedule-table">
  <thead><tr><th>ステップ</th><th>内容</th><th>所要時間</th></tr></thead>
  <tbody>
    <tr><td>STEP 1</td><td>アプリをダウンロード</td><td>約1分</td></tr>
    <tr><td>STEP 2</td><td>渡航先のプランを検索・購入</td><td>約2分</td></tr>
    <tr><td>STEP 3</td><td>eSIMをインストール・回線を切り替え</td><td>約2分</td></tr>
  </tbody>
</table>

出発前に自宅で設定しておけば、現地に到着した瞬間からデータ通信が使える。空港でレンタルWiFiを受け取る行列に並ぶ必要もない。

### 3. 24時間日本語サポートで安心

海外で通信トラブルが起きたとき、英語でのサポート対応は不安という方も多いだろう。トリファはアプリ内チャットで24時間・日本語サポートを提供している。時差を気にせずいつでも相談でき、W杯の深夜キックオフの試合前でも安心だ。

## W杯観戦で通信が必要な場面

スタジアムでの観戦中はもちろん、それ以外にも現地での通信環境は欠かせない。

<table class="schedule-table">
  <thead><tr><th>場面</th><th>通信が必要な理由</th></tr></thead>
  <tbody>
    <tr><td>チケット提示</td><td>FIFAアプリでの電子チケット表示に通信が必要</td></tr>
    <tr><td>スタジアムへの移動</td><td>Google MapsやUberでのナビ・配車</td></tr>
    <tr><td>SNS投稿</td><td>試合の感動をリアルタイムで共有</td></tr>
    <tr><td>情報収集</td><td>試合スケジュール変更、現地ニュースの確認</td></tr>
    <tr><td>緊急連絡</td><td>同行者との連絡、日本の家族への連絡</td></tr>
    <tr><td>翻訳</td><td>現地でのコミュニケーションに翻訳アプリを活用</td></tr>
  </tbody>
</table>

## フォロワー限定5%割引クーポン

当サイトのフォロワー様限定で、トリファのeSIMが5%割引になるクーポンコードを配布中。

<div class="highlight-box">
<span class="point-label">COUPON</span>
<span class="point-title">フォロワー限定5%割引クーポン</span>
<p class="point-body">Instagramフォロワー様：<strong>LIIBQZ</strong><br>TikTokフォロワー様：<strong>WIURLK</strong><br>※おひとり様一回まで利用可能</p>
</div>

W杯2026の遠征を計画しているなら、出発前にトリファのアプリをダウンロードして北米周遊プランをチェックしてみてほしい。5分の準備で、現地での通信ストレスがゼロになる。
...
<div class="highlight-box">
<span class="point-label">POINT</span>
<span class="point-title">This is a sponsored article</span>
<p class="point-body">This article was created in partnership with trifa. It includes exclusive discount coupon codes for followers.</p>
</div>

## What is trifa?

trifa is an overseas eSIM service covering over 200 countries and regions worldwide. It is Japan's most popular eSIM app by number of users. Simply download the app to your smartphone, and you can use mobile data abroad without swapping physical SIM cards.

Unlike rental WiFi devices that require airport pickup and return, trifa requires no physical equipment. Just purchase a plan in the app, install the eSIM, and you are ready to go.

<table class="profile-table">
  <tbody>
    <tr><th>Service</th><td>trifa</td></tr>
    <tr><th>Coverage</th><td>200+ countries and regions</td></tr>
    <tr><th>Data Options</th><td>1GB / 3GB / 5GB / 10GB / 20GB / 30GB / 80GB / Unlimited</td></tr>
    <tr><th>Duration</th><td>3 / 7 / 15 / 31 / 60 days</td></tr>
    <tr><th>Price</th><td>From approx. 790 yen per 1GB (varies by destination)</td></tr>
    <tr><th>Support</th><td>24/7 Japanese-language chat support</td></tr>
    <tr><th>Payment</th><td>Credit card, Apple Pay, Google Pay</td></tr>
  </tbody>
</table>

<small>* Prices may vary depending on the period. Please check the app for the latest pricing.</small>

## Why trifa is Perfect for World Cup 2026

### 1. North America Plan Covers USA & Mexico

World Cup 2026 venues are spread across 11 cities in the USA, 3 in Mexico, and 2 in Canada. Buying separate SIM cards for each country is inconvenient and costly.

With trifa's North America multi-country plan, a single eSIM covers both the USA and Mexico. No reconfiguration is needed when crossing borders — your data connection continues seamlessly.

<div class="highlight-box">
<span class="point-label">POINT</span>
<span class="point-title">Ideal for multi-country travel</span>
<p class="point-body">The North America plan lets you watch group stage matches in the USA and then travel to Mexico without needing to buy another eSIM. One eSIM covers multiple countries seamlessly.</p>
</div>

### 2. Setup in Just 5 Minutes

Setting up trifa is incredibly simple — just three steps:

<table class="schedule-table">
  <thead><tr><th>Step</th><th>Action</th><th>Time</th></tr></thead>
  <tbody>
    <tr><td>STEP 1</td><td>Download the app</td><td>~1 min</td></tr>
    <tr><td>STEP 2</td><td>Search and purchase a plan</td><td>~2 min</td></tr>
    <tr><td>STEP 3</td><td>Install eSIM and switch data line</td><td>~2 min</td></tr>
  </tbody>
</table>

Set it up at home before departure, and you will have data connectivity the moment you land. No need to queue at the airport for a rental WiFi device.

### 3. 24/7 Japanese-Language Support

Worried about troubleshooting connectivity issues in English while abroad? trifa offers 24/7 in-app chat support in Japanese. You can get help anytime regardless of time zones — even before a late-night kickoff.

## When You Need Connectivity at the World Cup

Beyond watching matches in the stadium, reliable connectivity is essential throughout your trip:

<table class="schedule-table">
  <thead><tr><th>Situation</th><th>Why You Need Data</th></tr></thead>
  <tbody>
    <tr><td>Ticket Display</td><td>FIFA app requires data to show digital tickets</td></tr>
    <tr><td>Getting to the Stadium</td><td>Google Maps navigation and Uber rides</td></tr>
    <tr><td>Social Media</td><td>Share the excitement in real time</td></tr>
    <tr><td>Information</td><td>Schedule changes, local news updates</td></tr>
    <tr><td>Emergency Contact</td><td>Reach travel companions or family back home</td></tr>
    <tr><td>Translation</td><td>Use translation apps for local communication</td></tr>
  </tbody>
</table>

## Exclusive 5% Discount Coupon for Followers

We have exclusive coupon codes for our followers to get 5% off trifa eSIM plans:

<div class="highlight-box">
<span class="point-label">COUPON</span>
<span class="point-title">Follower-Exclusive 5% Discount</span>
<p class="point-body">Instagram followers: <strong>LIIBQZ</strong><br>TikTok followers: <strong>WIURLK</strong><br>* One-time use per person</p>
</div>

If you are planning to travel for World Cup 2026, download the trifa app and check out the North America plan before you go. Just 5 minutes of preparation eliminates all connectivity stress on your trip.

<div class="takeaway-card">
<span class="point-label">TAKEAWAY</span>
<span class="point-title">Summary</span>
<p class="point-body">trifa's North America multi-country plan is the ideal eSIM service for Japanese supporters traveling across the USA and Mexico for World Cup 2026. Three key strengths: 5-minute setup via app, 24/7 Japanese support, and seamless multi-country coverage. Take advantage of the exclusive 5% follower discount coupon for a comfortable and affordable trip.</p>
</div>`,
  },
  {
    id: "1775721600001",
...
A. Both impressed on the UK tour but lack the international experience for a 26-man World Cup roster. They'll likely make the 55-man preliminary squad as emergency options.`,
  },
  {
    ...
    content: `スコットランドのグラスゴー、ハムデンパークのスタンドに、松葉杖なしで歩く遠藤航の姿があった。現地時間2026年3月28日、キリンワールドチャレンジのスコットランド戦。ピッチに立てない悔しさを飲み込みながら、日本代表のキャプテンはスタンドからチームを見守っていた。試合前には、キャプテンマークを託された前田大然から「コイントスのやり方を教えてほしい」と連絡が入り、丁寧にアドバイスを送ったという。
...
<div class="quote-box">
<p>「まだちょっと痛みがあるけど、来週から走れたらと思っている」——遠藤航（現地時間2026年3月28日、グラスゴーにて）</p>
</div>
...
<table class="schedule-table">
  ...
  <tbody>
    <tr><td>ハリー・ケイン</td><td>トッテナム</td><td>左足首靭帯損傷（2019年1月）</td><td>約2.5ヶ月</td><td>CL準々決勝に復帰。決勝にも出場</td></tr>
    <tr><td>マルコ・ロイス</td><td>ドルトムント</td><td>左足首靭帯部分断裂（2014年6月）</td><td>約3ヶ月</td><td>W杯直前の親善試合で負傷、本大会を断念</td></tr>
    <tr><td>ジャック・グリーリッシュ</td><td>マンチェスター・C</td><td>足首靭帯損傷（2023年）</td><td>約3ヶ月</td><td>シーズン後半に復帰し出場</td></tr>
...
<table class="schedule-table">
  ...
  <tbody>
    ...
    <tr><td>プレミアリーグ実績</td><td>リバプールで3シーズン目。1年目は主力、2年目以降はユーティリティとして貢献</td></tr>
    <tr><td>W杯経験</td><td>2022年カタール大会に出場。ドイツ戦・スペイン戦の勝利に貢献</td></tr>
  </tbody>
</table>

3月の親善試合では田中碧（リーズ）と藤田譲瑠チマ（シント・トロイデン）、佐野海舟（マインツ）らがボランチを務め、遠藤不在でも機能することを証明した。なお、守田英正（スポルティングCP）もCLベスト8進出の活躍にもかかわらず3月は招集外となっており、ボランチの競争は熾烈を極めている。しかし、遠藤が持つ**「プレミアリーグで毎週世界最高レベルの攻撃陣と対峙している経験値」**と**「キャプテンとしての精神的支柱」**は、代えが利かない。
...
**Q. 現在のリハビリ状況は？**
A. 現地時間3月28日のスコットランド戦を現地観戦した際、「まだちょっと痛みがあるけど、来週から走れたらと思っている」とコメント。松葉杖なしでの歩行が可能で、4月上旬のジョギング再開を目指している段階。

**Q. 遠藤不在時は誰が代役を務める？**
A. 3月の親善試合では田中碧（リーズ）や藤田譲瑠チマ（シント・トロイデン）、佐野海舟（マインツ）らがボランチを務めた。チームは遠藤なしで2連勝を果たしたが、W杯のオランダ戦などの大一番では遠藤のデュエル力とリーダーシップが不可欠とされている。`,
    contentEn: `At Hampden Park in Glasgow, Wataru Endo was spotted walking without crutches in the stands. March 28, 2026 (local time), Kirin World Challenge against Scotland. Unable to take the pitch, Japan's captain swallowed his frustration and watched from above. Before kickoff, Daizen Maeda — entrusted with the armband in Endo's absence — had called asking how to do the coin toss. Endo walked him through it, step by step.
...
On February 11, 2026, Premier League Matchday 26. Endo earned his first league start of the season — but not in his natural anchor role. He was deployed at **right-back**, a testament to his versatility in his third season at Liverpool, where playing time had become increasingly limited.
...
<div class="quote-box">
<p>"There's still a bit of pain, but I'm hoping to start running next week." — Wataru Endo (March 28, 2026 local time, Glasgow)</p>
</div>
...
<table class="schedule-table">
  ...
  <tbody>
    <tr><td>Harry Kane</td><td>Tottenham</td><td>Left ankle ligament (Jan 2019)</td><td>~2.5 months</td><td>Returned for CL quarterfinals; played in the final</td></tr>
    <tr><td>Marco Reus</td><td>Borussia Dortmund</td><td>Left ankle ligament tear (Jun 2014)</td><td>~3 months</td><td>Injured in pre-WC friendly; missed 2014 World Cup</td></tr>
    <tr><td>Jack Grealish</td><td>Manchester City</td><td>Ankle ligament injury (2023)</td><td>~3 months</td><td>Returned in second half of the season</td></tr>
...
<table class="schedule-table">
  ...
  <tbody>
    ...
    <tr><td>Premier League pedigree</td><td>Third season at Liverpool. Key starter in Year 1; utility role from Year 2 onward</td></tr>
    <tr><td>World Cup experience</td><td>Played in Qatar 2022; instrumental in victories over Germany and Spain</td></tr>
  </tbody>
</table>

In March friendlies, Ao Tanaka (Leeds United), Joel Fujita (Sint-Truiden), and Kaishu Sano (Mainz) shared midfield duties, proving the team can function without Endo. Notably, Hidemasa Morita (Sporting CP) was also left out of the March squad despite leading Sporting to the Champions League quarterfinals — a testament to the fierce competition in Japan's midfield. But Endo's **weekly experience competing against the world's best attackers in the Premier League** and his **irreplaceable spiritual leadership as captain** cannot be replicated.
...
A. As of March 28 (local time), he was walking without crutches and stated "there's still a bit of pain, but I'm hoping to start running next week." He traveled to Glasgow and London to watch Japan's March friendlies in person.

**Q. Who plays in his position when he's absent?**
A. Ao Tanaka (Leeds United), Joel Fujita (Sint-Truiden), and Kaishu Sano (Mainz) shared midfield duties in March friendlies, with Japan winning both matches. Even Hidemasa Morita (Sporting CP) was left out of the squad despite his Champions League exploits. However, Endo's Premier League-level duel ability and captaincy remain irreplaceable for marquee World Cup matches.`,
  },
  {
    id: "1775200800003",
...
**Q. 南野の代わりに誰が起用される？**
A. 鎌田大地（クリスタルパレス）のトップ下起用が最有力候補。久保建英（レアル・ソシエダ）もW杯での起用が期待されるが、1月のハムストリング負傷により3月は招集外だった。3月の親善試合では南野・久保不在ながら2連勝し、チームの層の厚さが証明されている。`,
...
The leading replacement candidate is **Daichi Kamada** (Crystal Palace) stepping into a central number 10 role. **Takefusa Kubo** (Real Sociedad) is also expected to feature at the World Cup, but a hamstring injury sustained in January kept him out of the March squad. Japan's 2-0 record in March friendlies without both Minamino and Kubo demonstrated impressive squad depth — but Minamino's irreplaceable big-game experience and spiritual leadership cannot be measured by statistics alone.
...
A. Daichi Kamada (Crystal Palace) shifting into a central number 10 role is the primary candidate. Takefusa Kubo (Real Sociedad) is also expected at the World Cup but missed the March squad with a hamstring injury. Japan went 2-0 in March without both Minamino and Kubo, demonstrating squad depth, though Minamino's big-game experience remains irreplaceable.`,
  },
  {
    id: "1775200800002",
...
<p class="point-body">(1) <strong>Gyökeres' 88th-minute winner</strong> sealed Sweden's 3-2 victory over Poland. A zero-to-hero story from last place in qualifying to World Cup qualification.<br>(2) <strong>Group F is set</strong>: Netherlands, Japan, Tunisia, Sweden. Japan vs Sweden on June 25 in Dallas will be a historic first World Cup meeting.<br>(3) <strong>Gyökeres and Isak</strong> form one of the tournament's most dangerous strike partnerships. Japan must not underestimate a Swedish side that peaked when it mattered most.</p>
  ...
  },
  {
    ...
    titleEn: "England Predicted XI vs Japan: How Tuchel Reshapes His Side After Nine Withdrawals — Kane and Gordon Lead a Revised Best XI",
    excerpt: "日本戦を前にサカ、ライス、ストーンズに加え、ベリンガムも欠場が確定したイングランド代表。トゥヘル監督はケイン、ゴードン、ロジャーズら残る戦力で4-2-3-1を組む見込み。予想フォーメーション、全11人の解説、注目選手5名を徹底分析。",
    excerptEn: "With Saka, Rice, Stones, Bellingham and five others withdrawn, Tuchel must rebuild his England XI for the Japan friendly. We predict a 4-2-3-1 featuring Kane, Gordon, and Rogers, and profile five key players to watch.",
    category: "日本代表" as const,
    tags: ["イングランド", "日本代表", "予想スタメン", "ハリー・ケイン", "モーガン・ロジャーズ", "アンソニー・ゴードン", "ベン・ホワイト", "トゥヘル", "W杯2026", "親善試合"],
    tagsEn: ["England", "Japan", "Predicted XI", "Harry Kane", "Morgan Rogers", "Anthony Gordon", "Ben White", "Tuchel", "World Cup 2026", "Friendly"],
...
ウルグアイ戦（1-1）後に8名の離脱が発表されたのに続き、30日にはトゥヘル監督がベリンガムの欠場も明言。計9名が日本戦に出場できない事態となった。

<table class="schedule-table">
  <thead><tr><th>選手</th><th>ポジション</th><th>所属</th><th>理由</th></tr></thead>
  <tbody>
    <tr><td>ジュード・ベリンガム</td><td>MF</td><td>レアル・マドリード</td><td>筋肉系負傷からの復帰直後。「リスクは冒したくない」（トゥヘル）</td></tr>
...
<div class="highlight-box">
<span class="point-label">POINT</span>
<span class="point-title">離脱の影響——4つのポジションに穴</span>
<p class="point-body">最も大きな影響を受けるのは<strong>トップ下</strong>（ベリンガム欠場で最大の切り札が不在）、<strong>右ウイング</strong>（サカ＆マドゥエケの両方が離脱）、<strong>アンカー</strong>（ライス不在）、<strong>センターバック</strong>（ストーンズ＆トモリの2枚が抜けた）の4ポジション。ベリンガムの欠場は前日に発表された最新の離脱で、サカ・ライス・ベリンガムというイングランドの「核」3人が揃わない異例の事態となった。</p>
</div>
...
<table class="profile-table">
  <tbody>
    ...
    <tr><th>AM</th><td>モーガン・ロジャーズ（アストン・ヴィラ）or コール・パーマー（チェルシー）</td></tr>
...
**AM ロジャーズ or パーマー**——ベリンガムの欠場確定により、トップ下はモーガン・ロジャーズ（アストン・ヴィラ）が最有力。ウルグアイ戦でベン・ホワイトのゴールをお膳立てしたコール・パーマー（チェルシー）がRWに入り、ロジャーズがトップ下に収まる形も考えられる。
...
<div class="highlight-box">
<span class="point-label">POINT</span>
<span class="point-title">ウルグアイ戦からの「11人チェンジ」——しかし9名離脱の痛手</span>
<p class="point-body">トゥヘル監督はウルグアイ戦とは全員を入れ替える方針。当初は「W杯候補のファーストチョイス」を試す場だったが、サカ・ライス・ベリンガムという攻守の核3人を含む9名が離脱。右ウイング、トップ下、アンカー、CBの4ポジションが「代替案」での臨戦となる。それでもケイン・ゴードン・ギュエイら世界クラスの選手が並ぶ点は変わらない。</p>
</div>
...
### 2. モーガン・ロジャーズ（アストン・ヴィラ／AM）

<table class="schedule-table">
  <thead><tr><th>項目</th><th>データ</th></tr></thead>
  <tbody>
    <tr><td>年齢</td><td>22歳</td></tr>
    <tr><td>所属</td><td>アストン・ヴィラ</td></tr>
    <tr><td>特徴</td><td>ドリブル突破、ライン間でのボール受け、推進力</td></tr>
  </tbody>
</table>

ベリンガム欠場によりトップ下の最有力候補に浮上。アストン・ヴィラではウナイ・エメリの下で急成長を遂げ、ドリブルでの推進力とライン間でボールを受ける感覚に優れる。ベリンガムほどの知名度はないが、日本の中盤にとっては「未知数の脅威」となる。田中碧・藤田譲瑠チマとのマッチアップが見どころ。
...
<p class="point-body">（1）サカ・ライス・ベリンガムら主力9名離脱で、当初想定の「ベストXI」からは大幅に変更。それでもケイン・ゴードンら世界クラスの攻撃陣は健在。<br>（2）予想フォーメーションは4-2-3-1。ベリンガム欠場でトップ下はロジャーズが最有力。右SBはコンサ vs ホワイトの争い。<br>（3）日本にとっては「中盤のプレス」「左サイドの仕掛け」「CBへの圧力」が勝利の鍵。9名離脱で生まれた隙を突けるかが勝敗を分ける。</p>
</div>`,
...
Following the Uruguay draw, eight players were withdrawn. Then on March 30, Tuchel confirmed Bellingham would also miss the Japan match — bringing the total to nine absentees.

<table class="schedule-table">
  <thead><tr><th>Player</th><th>Position</th><th>Club</th><th>Reason</th></tr></thead>
  <tbody>
    <tr><td>Jude Bellingham</td><td>MF</td><td>Real Madrid</td><td>Muscle injury recovery. "I don't want to take risks" (Tuchel)</td></tr>
...
<div class="highlight-box">
<span class="point-label">POINT</span>
<span class="point-title">Four Positions Hit Hardest</span>
<p class="point-body">The biggest impact falls on <strong>attacking midfield</strong> (Bellingham ruled out — England's biggest creative threat is absent), <strong>right wing</strong> (both Saka and Madueke gone — only Jarrod Bowen remains), <strong>defensive midfield</strong> (Rice's absence leaves a void), and <strong>center-back</strong> (Stones and Tomori both withdrawn). The loss of Saka, Rice, and Bellingham — England's three most important outfield players — is an unprecedented blow.</p>
</div>
...
<table class="profile-table">
  <tbody>
    ...
    <tr><th>AM</th><td>Morgan Rogers (Aston Villa) or Cole Palmer (Chelsea)</td></tr>
...
**AM Rogers or Palmer** — With Bellingham ruled out, Morgan Rogers (Aston Villa) is the frontrunner for the No. 10 role. Cole Palmer (Chelsea), who created White's goal against Uruguay, could play at right wing with Rogers moving centrally.
...
<div class="highlight-box">
<span class="point-label">POINT</span>
<span class="point-title">11 Changes from Uruguay — But Nine Absentees Bite Hard</span>
<p class="point-body">Tuchel is expected to change all 11 players from the Uruguay match, but the loss of Saka, Rice, and Bellingham — England's three most important outfield players — means this is far from the World Cup dress rehearsal originally planned. The right wing, No. 10, anchor, and center-back positions are all "Plan B" selections. Still, Kane, Gordon, and Guehi ensure world-class quality remains.</p>
</div>
...
### 2. Morgan Rogers (Aston Villa / AM)

<table class="schedule-table">
  <thead><tr><th>Stat</th><th>Data</th></tr></thead>
  <tbody>
    <tr><td>Age</td><td>22</td></tr>
    <tr><td>Club</td><td>Aston Villa</td></tr>
    <tr><td>Strengths</td><td>Dribbling, ball-carrying, receiving between lines</td></tr>
  </tbody>
</table>

With Bellingham ruled out, Rogers emerges as the leading candidate for the No. 10 role. He has developed rapidly under Unai Emery at Aston Villa, combining explosive dribbling with intelligent movement between the lines. Less well-known than Bellingham, but Japan's midfield will face an "unknown threat" that is no less dangerous.
...
<p class="point-body">(1) Nine withdrawals — including Saka, Rice, Bellingham, and Stones — mean this is far from the "best XI" originally envisioned. However, Kane and Gordon still provide world-class attacking firepower.<br>(2) Predicted formation: 4-2-3-1. With Bellingham out, Rogers is the frontrunner at No. 10. Right-back remains Konsa vs White.<br>(3) For Japan, the keys to victory are pressing the midfield, attacking down the left, and pressuring the unfamiliar CB pairing. Nine withdrawals have created genuine vulnerabilities to exploit.</p>
</div>`,
  },
  {
    id: "1775030400001",
