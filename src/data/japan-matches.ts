...
export const japanMatches: JapanMatch[] = [
  ...
  // ── 2. MD9 オーストラリア 1-0 日本 ──
  {
    ...
    formationPositions: f3421({
      ...
      lwb: [11, "平川諒也"], lcm: [5, "佐野海舟"], rcm: [7, "藤田譲瑠チマ"], rwb: [20, "俵積田晃太"],
      lss: [15, "鎌田大地"], rss: [9, "大橋祐紀"], st: [18, "町野修斗"],
    }),
    starting: [
      ...
      { number: 2, name: "Hiroki Sekine", nameJa: "関根大輝", position: "DF" },
      { number: 11, name: "Yu Hirakawa", nameJa: "平川諒也", position: "MF" },
      { number: 5, name: "Kaishu Sano", nameJa: "佐野海舟", position: "MF" },
      { number: 7, name: "Joel Chima Fujita", nameJa: "藤田譲瑠チマ", position: "MF" },
    ...
    substitutions: [
      ...
      { minute: "64", playerIn: "久保建英", playerOut: "俵積田晃太" },
      { minute: "64", playerIn: "中村敬斗", playerOut: "佐野海舟" },
      { minute: "69", playerIn: "町野修斗→別選手", playerOut: "大橋祐紀" },
      { minute: "70", playerIn: "高井幸大", playerOut: "渡辺剛" },
    ],
    highlights: [
  ...
  // ── 3. MD8 日本 0-0 サウジアラビア ──
  {
    ...
    formation: "3-4-2-1",
    formationPositions: f3421({
      gk: [1, "鈴木彩艶"], lcb: [2, "菅原由勢"], ccb: [4, "板倉滉"], rcb: [21, "伊藤洋輝"],
      lwb: [3, "高井幸大"], lcm: [17, "田中碧"], rcm: [6, "遠藤航"], rwb: [13, "中村敬斗"],
    ...
    starting: [
      ...
      { number: 3, name: "Kota Takai", nameJa: "高井幸大", position: "MF" },
    ...
    bench: [
      { number: 12, name: "Keisuke Osako", nameJa: "大迫敬介", position: "GK" },
      { number: 5, name: "Hiroki Sekine", nameJa: "関根大輝", position: "DF" },
  ...
  // ── 5. MD6 中国 1-3 日本 ──
  {
    ...
    goals: [
      ...
      { minute: "45+6", player: "板倉滉", team: "away" },
    ...
    substitutions: [
      { minute: "68", playerIn: "鎌田大地", playerOut: "南野拓実" },
      { minute: "77", playerIn: "古橋亨梧", playerOut: "小川航基" },
      { minute: "77", playerIn: "橋岡大樹", playerOut: "伊東純也" },
      { minute: "86", playerIn: "前田大然", playerOut: "久保建英" },
    ],
    highlights: [
  ...
  // ── 6. MD5 インドネシア 0-4 日本 ──
  {
    ...
    goals: [
      ...
      { minute: "50", player: "南野拓実", team: "away" },
      { minute: "56", player: "守田英正", team: "away" },
      { minute: "82", player: "菅原由勢", team: "away" },
    ],
    formation: "3-4-2-1",
    formationPositions: f3421({
      gk: [1, "鈴木彩艶"], lcb: [3, "橋岡大樹"], ccb: [4, "板倉滉"], rcb: [16, "町田浩樹"],
      lwb: [7, "三笘薫"], lcm: [6, "遠藤航"], rcm: [5, "守田英正"], rwb: [14, "伊東純也"],
  ...
  // ── 7. MD4 日本 1-1 オーストラリア ──
  {
    ...
    goals: [
      { minute: "50", player: "バージェス（OG）", team: "home" },
      { minute: "72", player: "ベヒッチ", team: "away" },
    ],
    formation: "3-4-2-1",
    formationPositions: f3421({
    ...
    highlights: [
      ...
      "50分、日本の攻撃からオーストラリアのバージェスがOGで日本に先制点をもたらす",
  ...
  // ── 8. MD3 サウジアラビア 0-2 日本 ──
  {
    ...
    substitutions: [
      ...
      { minute: "88", playerIn: "中村敬斗", playerOut: "堂安律" },
    ],
    highlights: [
  ...
  // ── 9. MD2 バーレーン 0-5 日本 ──
  {
    ...
    substitutions: [
      ...
      { minute: "65", playerIn: "久保建英", playerOut: "南野拓実" },
  ...
  // ── 10. MD1 日本 7-0 中国 ──
  {
    ...
    substitutions: [
      ...
      { minute: "79", playerIn: "伊東純也", playerOut: "三笘薫" },
    ],
    highlights: [
